...
test("correctly fetches a movie result for Shrek", async()=>{
    ...
    expect(actualValue).toEqual( {"data": [{"adult": false, "backdrop": "/sRvXNDItGlWCqtO3j6wks52FmbD.jpg", "genre_ids": [16, 35, 14, 12, 10751], "id": 808, "original_language": "en", "original_title": "Shrek", "overview": "It ain't easy bein' green -- especially if you're a likable (albeit smelly) ogre named Shrek. On a mission to retrieve a gorgeous princess from the clutches of a fire-breathing dragon, Shrek teams up with an unlikely compatriot -- a wisecracking donkey.", "popularity": 207.13, "poster_path": "/jhTVNBVkdS4Wf6NXYA9kRKQU3YM.jpg", "release_date": "2001-05-18", "title": "Shrek", "video": false, "vote_average": 7.716, "vote_count": 14992}], "status": "MOCK"}
);
})
